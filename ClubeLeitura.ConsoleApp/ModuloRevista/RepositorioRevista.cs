...
namespace ClubeLeitura.ConsoleApp.ModuloRevista
{
    internal class RepositorioRevista : RepositorioBase
    {
        ...
        {
            Revista revistaComCaixaUm = new Revista(1, "Progamar É viver", 777, "01/02/2020", _repositorioCaixa.SelecionarPorId(1));
            Revista revistaComCaixaDois = new Revista(2, "gonaie young", 4312, "11/07/2023", _repositorioCaixa.SelecionarPorId(2));
            Revista revistaComCaixaTres = new Revista(3, "Cigarretes", 2018, "23/12/2021", _repositorioCaixa.SelecionarPorId(3));
